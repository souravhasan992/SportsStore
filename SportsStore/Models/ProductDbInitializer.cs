...
namespace SportsStore.Models
{
    public class ProductDbInitializer : DropCreateDatabaseAlways<ProductDbContext>
    {
        ...
        {
            new List<Product> { new Product() { Name = "Kayak", Description = "A boat for one person", Category = "Watersports", Price = 275m },
                ...
                new Product() { Name = "Thinking Cap", Description = "Improve your brain efficiency by 75%", Category = "Chess", Price = 16m }, 
            ...
            new List<Order> { 
                ...
                new Order() { Customer = "Peter Jones", TotalCost = 79791m, Lines = new List<OrderLine> {
